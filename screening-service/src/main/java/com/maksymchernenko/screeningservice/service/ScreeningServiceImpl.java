...
import com.maksymchernenko.screeningservice.client.MovieClient;
import com.maksymchernenko.screeningservice.client.MovieDTO;
import com.maksymchernenko.screeningservice.exception.NotFoundException;
import com.maksymchernenko.screeningservice.model.*;
import com.maksymchernenko.screeningservice.repository.HallRepository;
import com.maksymchernenko.screeningservice.repository.ScreeningRepository;
import com.maksymchernenko.screeningservice.repository.ScreeningSeatRepository;
import com.maksymchernenko.screeningservice.repository.SeatRepository;
...
public class ScreeningServiceImpl implements ScreeningService {
    ...
    public String lockSeats(Integer screeningId, List<Integer> seatIds) {
        ...
        for (ScreeningSeat s : seats) {
            if (s.getStatus() == ScreeningSeat.Status.LOCKED &&
                    s.getExpiresAt() != null &&
